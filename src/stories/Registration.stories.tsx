...
const LoginTemplate: ComponentStory<typeof Login> = (args) => (
  <Login {...args} />
);
export const LoginSimple = LoginTemplate.bind({});

const LoginPasswordSendTemplate: ComponentStory<typeof LoginPasswordSend> = (
  args,
) => <LoginPasswordSend {...args} />;
export const LoginPasswordSendSimple = LoginPasswordSendTemplate.bind({});

const LoginResetPasswordTemplate: ComponentStory<typeof LoginResetPassword> = (
  args,
) => <LoginResetPassword {...args} />;
export const LoginResetPasswordSimple = LoginResetPasswordTemplate.bind({});

const LoginVerificationLinkTemplate: ComponentStory<
  typeof LoginVerificationLink
> = (args) => <LoginVerificationLink {...args} />;
export const LoginVerificationLinkSimple = LoginVerificationLinkTemplate.bind(
  {},
);

const SignUpBasicInfoTemplate: ComponentStory<typeof SignUpBasicInfo> = (
  args,
) => <SignUpBasicInfo {...args} />;
export const SignUpBasicInfoSimple = SignUpBasicInfoTemplate.bind({});

const SignUpLandingTemplate: ComponentStory<typeof SignUpLanding> = (args) => (
  <SignUpLanding {...args} />
);
...
LoginSimple.args = {
  onLogin: async (values) => {
    ...
    return alert(
      `On Login: ${JSON.stringify(values)} | response: ${JSON.stringify(
        response,
      )}`,
    );
  },
